...
func marshalToolResultPart(p ToolResultPart) (json.RawMessage, error) {
	parts, err := marshalParts(p.Parts)
	if err != nil {
		return nil, err
	}
...
func marshalPart(part Part) (json.RawMessage, error) {
	...
	case *TextPart:
		if p == nil {
			return nil, fmt.Errorf("%w: nil text part", ErrBadRequest)
		}
		return p.MarshalJSON()
	case ImagePart:
		return p.MarshalJSON()
	case *ImagePart:
		if p == nil {
			return nil, fmt.Errorf("%w: nil image part", ErrBadRequest)
		}
		return p.MarshalJSON()
	case FilePart:
		return p.MarshalJSON()
	case *FilePart:
		if p == nil {
			return nil, fmt.Errorf("%w: nil file part", ErrBadRequest)
		}
		return p.MarshalJSON()
	case ToolCallPart:
		return p.MarshalJSON()
	case *ToolCallPart:
		if p == nil {
			return nil, fmt.Errorf("%w: nil tool call part", ErrBadRequest)
		}
		return p.MarshalJSON()
	case ToolResultPart:
		return p.MarshalJSON()
	case *ToolResultPart:
		if p == nil {
			return nil, fmt.Errorf("%w: nil tool result part", ErrBadRequest)
		}
		return p.MarshalJSON()
	case ReasoningPart:
		return p.MarshalJSON()
	case *ReasoningPart:
		if p == nil {
			return nil, fmt.Errorf("%w: nil reasoning part", ErrBadRequest)
		}
		return p.MarshalJSON()
	case UnknownPart:
		return p.MarshalJSON()
	case *UnknownPart:
		if p == nil {
			return nil, fmt.Errorf("%w: nil unknown part", ErrBadRequest)
		}
		return p.MarshalJSON()
	}
